...
class UploadAndDownloadPage(BasePage):
    ...
    def upload_file(self):
        ...
        self.element_is_present(self.locators.UPLOAD_INPUT).send_keys(path)
        os.remove(path)
    ...
    def download_file(self):
        ...
        path_name_file = rf'C:\Users\Nik\PycharmProjects\artLessons\filetest{random.randint(0, 99)}.jpg'
...
class DynamicPropertiesPage(BasePage):
    ...
    def check_appear_of_button(self):
        try:
            self.element_is_visible(self.locators.VISIBLE_AFTER_5_SEC_BUTTON, 5)
        except TimeoutException:
            return False
        return True
