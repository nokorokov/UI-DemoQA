...
class TestElements:
    ...
    class TestRadioButton:
        ...
        def test_radio_button(self, driver):
            ...
            radio_button_page.click_on_the_radio('yes')
            output_yes = radio_button_page.output_result()
            radio_button_page.click_on_the_radio('impressive')
            output_impressive = radio_button_page.output_result()
            radio_button_page.click_on_the_radio('no')
    ...
    class TestWebTable:
        ...
        @allure.title('Check person search in table')
        ...
        @allure.title('Check edit person info')
        ...
        @allure.title('Check delete person from table')
    ...
    class TestDynamicPropertiesPage:
        ...
        def test_enable_button(self, driver):
            ...
            assert enable is True, 'button did not clickable'
